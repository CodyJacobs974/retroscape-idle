...
TREES = {
    ...
    "Oak Tree":     {"level_req": 15, "xp": 37.5,  "log_id": "oak_log",      "respawn_time": 8},
    "Willow Tree":  {"level_req": 30, "xp": 67.5,  "log_id": "willow_log",   "respawn_time": 12},
    "Teak Tree":    {"level_req": 35, "xp": 85,    "log_id": "teak_log",     "respawn_time": 15}, # Requires specific locations in OSRS, simplified here
    "Maple Tree":   {"level_req": 45, "xp": 100,   "log_id": "maple_log",    "respawn_time": 20},
    "Mahogany Tree":{"level_req": 50, "xp": 125,   "log_id": "mahogany_log", "respawn_time": 25}, # Requires specific locations in OSRS
    # Yew Tree (Level 60) would be next but instructions are *up to* 60, so Mahogany at 50 is the last one for now.
    # If "up to 60" means including 60, Yew would be added. For now, interpreting as <60 content.
    # Let's add Yew as it's a classic level 60 tree.
